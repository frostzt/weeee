...
export class Migration20211108090308 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "task" ("id" varchar(255) not null default \'37d2d7b6-4e29-4b61-9e9e-3b1a5f8419e8\', "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "title" varchar(255) not null, "description" varchar(255) not null, "created_by_company_id" varchar(255) not null, "assigned_to_id" varchar(255) not null);');
